...
try:
        ...
        def run(self):
            ...
            while True:
                try:
                    ...
                    try:
                        print(Fore.CYAN + '[+] WEB MIGHT BE DOWN !!! Status Response is : %s\n' % e)
                    finally:
                        e = None
                        del e

                except urllib.request.URLError:
                    print(Fore.RED + '[+] SOMETHING ERROR , CHECK URL !!!\n')
                except ValueError:
                    print(Fore.RED + '[+]Checking The URL or Something ERROR !!!\n')
                except KeyboardInterrupt:
                    exit(Fore.RED + '[-]Canceled By DIEP MINH KHANG !!!')
                except Exception:
    ...
    class MainLoop:
        ...
        def home(self):
            global Flood_Mode
            global in_proxies
            print(Fore.YELLOW + "  \n LIKE TOOL VERSION 2 =)))))) BY DMK \n Facebook: facebook.com/dmk.dz.208 \n Zalo: 0325632051 \n ")
            if os.name in ('nt', 'dos', 'ce'):
                os.system('title       LIKE-DDOS VERSION 2 MAKE BY DIEP MINH KHANG')
            try:
